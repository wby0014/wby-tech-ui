      ...
      methods: {
            ...
            'series': [
              {
                ...
                'type': 'line',
                'stack': '总量',
                'data': [20, 132, 400, 60, 900, 430, 210]
              },
              {
                'name': '微信',
                'type': 'line',
                'stack': '总量',
                'data': [120, 782, 191, 634, 290, 530, 910]
              },
              {
                'name': '抖音',
                'type': 'line',
                'stack': '总量',
                'data': [750, 632, 601, 654, 590, 830, 1010]
              },
              {
                'name': '微博',
                'type': 'line',
                'stack': '总量',
                'data': [220, 32, 501, 34, 390, 330, 320]
              },
              {
                'name': '头条',
                'type': 'line',
                'stack': '总量',
                'data': [220, 2232, 601, 534, 490, 330, 120]
              }
            ]
          }
        ...
        initChartBar () {
          var option = {
            ...
            legend: {
              data: ['QQ', '微信', '抖音', '微博', '头条', '百度', '谷歌', '必应', '其他']
            },
            grid: {
              left: '3%',
              right: '4%',
        ...
        initChartScatter () {
          var option = {
            ...
            title: {
              text: '1990 与 2020 年各国家人均薪资与 GDP'
            },
            legend: {
              right: 10,
              data: ['1990', '2020']
